...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9842132);
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "click-21156.mp3", false, 100, 1);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9843340);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
{gdjs.evtTools.window.openURL("https://mywebar.com/p/Project_0_7jjp6sz9sb", runtimeScene);
}
{ //Subevents
