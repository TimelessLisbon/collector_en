...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9292844);
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "click-21156.mp3", false, 100, 1);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9294244);
}
if (isConditionTrue_0) {
...
{runtimeScene.getGame().getVariables().getFromIndex(2).setNumber(28);
    ...
    gdjs.S_46_32CarlosCode.GDnext_9595sceneObjects1[i].setString("Fim");
}
...
gdjs.S_46_32CarlosCode.eventsList23(runtimeScene);
